{
  description = "a2ml_gleam - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 a2ml_gleam development environment"
            echo "Language: gleam"
            echo ""
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P a2ml_gleam.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/a2ml_gleam $out/bin/  # Rust
            # cp bin/a2ml_gleam $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/a2ml_gleam";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-a2ml_gleam" {

...
All notable changes to `a2ml_gleam` will be documented in this file.
...
- fix(ci): sync hypatia-scan.yml to canonical (kill cd-scanner build drift) (#19)
- fix(ci): adopt canonical hypatia-scan.yml (env.HOME/scanner-layout + Comment-step gate) (#18)
